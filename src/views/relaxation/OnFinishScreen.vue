<template>
  <ion-page>
    ...
    <ion-content :fullscreen="true">
      <Vue3Lottie :animationData="animationData" :height="150" :width="150" class="lottie"
        style=" margin-left: -3vw; margin-top: 4vh;" />
      ...
      <div style="margin-left: 1rem;">
        ...
        <div style="margin-top: 4vh;">
          <ion-label>Дыхательные упражнения помогли вам успокоиться и вернуть баланс в свое эмоциональное
            состояние.<br /><br /> </ion-label>
        </div>
...
export default defineComponent({
  ...
  mounted() {
    ...
    console.log("xer5ctvybun67tg7yhubhgu " + typeof OffscreenCanvas)
    ...
    setTimeout(() => {
      ...
      var interval = setInterval(function () {
        ...
        // confetti(Object.assign({}, defaults, { particleCount, origin: { x: randomInRange(0.1, 0.3), y: Math.random() - 0.1 }, useWorker: false }));
        // confetti(Object.assign({}, defaults, { particleCount, origin: { x: randomInRange(0.7, 0.9), y: Math.random() - 0.1 }, useWorker: false }));
      }, 250);
    }, 6000);
