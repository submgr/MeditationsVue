<template>
    ...
    " />
                        ...
                        <div style="margin-top: 5vh; margin-left: 1vw;">
                            <p>Помогите приложению определить состояние вашего психологического благополучия на данный момент, пройдя небольшой тест. Вам предстоит ответить на несколько вопросов. Постарайтесь расслабиться и отвечать как можно более честно, прежде всего — от души.</p>
